#### Using Seaborn and Matplotlib for making EDA (Exploratory Data Analysis) and visualization ,Then using Scikit Learn for making Random Forest model for predicting effect of actions on specific features
